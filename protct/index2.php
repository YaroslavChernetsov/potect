...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <h1>
        <a href="#" class="logo">злая еда<span class="span">.</span></a>
      </h1>
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li class="nav-item">
            <a href="#home" class="navbar-link" data-nav-link>главное</a>
          </li>

          <li class="nav-item">
            <a href="#about" class="navbar-link" data-nav-link>акции </a>
          </li>

          <li class="nav-item">
            <a href="#food-menu" class="navbar-link" data-nav-link>магазин</a>
          </li>
    ...
    <article>
      ...
      <section class="hero" id="home" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">еда</p>

            <h2 class="h1 hero-title">купи хороший бургер!</h2>

            <p class="hero-text">Это еда натуральная с хорошим послевкусье.</p>

            <button class="btn">меню</button>
          ...
          <ul class="promo-list has-scrollbar">
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Мексиканская пицца</h3>

                <p class="card-text">
                  Эта еда очень хорошо помагает организму.
                </p>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">безалкогольные напитки</h3>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">куриные ножки</h3>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Завтрак </h3>

                <p class="card-text">
                  Очень полезно есть утром.
                </p>
            ...
            <li class="promo-item">
              <div class="promo-card">
                ...
                <h3 class="h3 card-title">Овощной завтрак </h3>
        ...
        <div class="container">
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">
              Кафе, бургеры и лучшая пицца!
              <span class="span">в городе!</span>
            </h2>

            <p class="section-text">
              Рестораны в Ханчжоу также обслуживали многих северных китайцев, бежавших на юг из Кайфэна во
              время вторжения чжурчжэней в 1120-х годах, хотя также известно, что многими ресторанами управляли семьи.
            </p>
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <span class="span">Вкусная и здоровая пища</span>
              </li>

              <li class="about-item">
                <ion-icon name="checkmark-outline"></ion-icon>

                <span class="span">Просторная зона для семьи и детей</span>
              </li>

              <li class="about-item">
                <ion-icon name="checkmark-outline"></ion-icon>

                <span class="span">Музыка и другие удобства</span>
              </li>

              <li class="about-item">
                <ion-icon name="checkmark-outline"></ion-icon>

                <span class="span">Быстрая доставка еды на дом</span>
              </li>

            </ul>

            <button class="btn btn-hover">Заказывайте прямо сейчас</button>
      ...
      <section class="section food-menu" id="food-menu">
        <div class="container">
          ...
          <p class="section-subtitle">Популярная заказы</p>

          <h2 class="h2 section-title">
            Закажи еду с  <span class="span">собой</span>
          </h2>

          <p class="section-text">
            Осторожно эта еда настолько вкусная что может убить вас.
          </p>

          <ul class="fiter-list">

            <li>
              <button class="filter-btn  active">Тортик это ложь</button>
            </li>
          ...
          <ul class="food-menu-list">
            ...
            <li>
              <div class="food-menu-card">
                ...
                <div class="card-banner">
                  ...
                  <button class="btn food-menu-btn">Закажи сейчас</button>
                </div>

                <div class="wrapper">
                  <p class="category">Морепродукты</p>
                ...
                <h3 class="h3 card-title">Убиственые морепродукты</h3>

                <div class="price-wrapper">

                  <p class="price-text">Скидка:</p>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <h3 class="h3 card-title">Убиственая Закуска</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <h3 class="h3 card-title">Просто вкусная курица</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <h3 class="h3 card-title">Лучшие офощи города</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <h3 class="h3 card-title">Стейк вкусно и запятая</h3>
            ...
            <li>
              <div class="food-menu-card">
                ...
                <h3 class="h3 card-title">Взрывное блюдо</h3>
      ...
      <section class="section section-divider white cta" style="background-image: url('./assets/images/hero-bg.jpg')">
        <div class="container">
          ...
          <div class="cta-content">
            ...
            <h2 class="h2 section-title">
              У Гурмана Есть Отличные Из
              <span class="span">Качественные бургеры!</span>
            </h2>

            <p class="section-text">
              Купи по скидке пока не поздно 
            </p>

            <button class="btn btn-hover">Закжи сейчас</button>
          </div>
      ...
      <section class="section section-divider gray delivery">
        <div class="container">
          ...
          <div class="delivery-content">
            ...
            <h2 class="h2 section-title">
              Момент Доставки <span class="span">В Нужное Время</span> и в нужном Месте
            </h2>

            <p class="section-text">
              Воремя доставят в течнии 30 минут или бесплатно.
            </p>

            <button class="btn btn-hover">Закажи сейчас</button>
          </div>
      ...
      <section class="section section-divider white testi">
        <div class="container">
          ...
          <p class="section-subtitle">Рекомендации</p>

          <h2 class="h2 section-title">
            Наши клиенты <span class="span">Обзоры</span>
          </h2>

          <p class="section-text">
            Эта лучшая еда что я пробовал в своей жизни это помогло мне изличить рак
          </p>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <div>
                    <h3 class="h4 testi-name">Николай </h3>

                    <p class="testi-title">Король отзывов</p>
                  </div>

                </div>

                <blockquote class="testi-text">
                  "Когда я попробовал это мой живот расплавился от счастья  ."
                </blockquote>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <div>
                    <h3 class="h4 testi-name">Гор</h3>

                    <p class="testi-title">Истиный тимлид</p>
                  </div>
            ...
            <li class="testi-item">
              <div class="testi-card">
                ...
                <div class="profile-wrapper">
                  ...
                  <div>
                    <h3 class="h4 testi-name">неизвестный</h3>

                    <p class="testi-title">исвестный</p>
                  </div>
          ...
          <ul class="banner-list">
            ...
            <li class="banner-item banner-lg">
              <div class="banner-card">
                ...
                <div class="banner-item-content">
                  <p class="banner-subtitle">50% Сейчас!</p>

                  <h3 class="banner-title">Лапша!</h3>

                  <p class="banner-text">Только на этой неделе</p>

                  <button class="btn">Сейчас</button>
                </div>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <div class="banner-item-content">
                  <h3 class="banner-title">Пицца</h3>

                  <p class="banner-text">50% Сейчас</p>

                  <button class="btn">Закажи сейчас</button>
                </div>
            ...
            <li class="banner-item banner-sm">
              <div class="banner-card">
                ...
                <div class="banner-item-content">
                  <h3 class="banner-title">Американский бургер</h3>
            ...
            <li class="banner-item banner-md">
              <div class="banner-card">
                ...
                <div class="banner-item-content">
                  <h3 class="banner-title">Тестовая пицца</h3>

                  <p class="banner-text">Только на этой недели </p>
      ...
      <section class="section section-divider white blog" id="blog">
        <div class="container">
          ...
          <p class="section-subtitle">Посты</p>

          <h2 class="h2 section-title">
            Здесь вся  <span class="span">еда</span>
          </h2>

          <p class="section-text">
            Все это полезно для организма.
          </p>
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <p class="meta-info">JOhfn</p>
                    </a>

                  </div>

                  <h3 class="h3">
                    <a href="#" class="card-title">Вкусно ли это?</a>
                  </h3>
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <p class="meta-info">Фанат бутеров </p>
                    </a>

                  </div>

                  <h3 class="h3">
                    <a href="#" class="card-title">Очень вкусно говорю как фанат.</a>
                  </h3>
                ...
                <div class="card-content">
                  ...
                  <div class="card-meta-wrapper">
                    ...
                    <a href="#" class="card-meta-link">
                      ...
                      <p class="meta-info">Ярэ</p>
                    </a>

                  </div>

                  <h3 class="h3">
                    <a href="#" class="card-title">Рекомендую шашлыки из барнины.</a>
                  </h3>
    ...
    <div class="footer-top" style="background-image: url('./assets/images/footer-illustration.png')">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-text">
           Вы можете зарегистрироватся сейчас.
          </p>
        ...
        <ul class="footer-list">
          ...
          <li>
            <p class="footer-list-item">Info@YGmail24.com</p>
          </li>
...
<?php
require_once 'include/db.php-protct\include';
?>